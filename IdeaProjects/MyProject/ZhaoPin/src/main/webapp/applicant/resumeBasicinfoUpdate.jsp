...
<div class="resume_con">
    ...
    <div class="resume_main">
	    ...
	    <div class="resume_left">
			...
			<form action="resume.do?type=modify" method="post">
				<div class="all_resume">
					<div class="table_style">
 
						<table width="300" border="0" cellpadding="3" cellspacing="1" bgcolor="#EEEEEE">
						  <tr>
						    <th width="110" align="right" bgcolor="#F8F8F8">姓名：
						    	<input type="hidden" name="basicinfoId" value="${resumeInfo.basicinfoId }">
						    	<input type="hidden" name="applicantId" value="${resumeInfo.applicantId }">
						    </th>
						    <td bgcolor="#F8F8F8"><input type="text" name="realName" value="${resumeInfo.realName }"></td>
						  </tr>
						</table>
						<div class="he"></div>
						<table width="300" border="0" cellpadding="3" cellspacing="1" bgcolor="#EEEEEE">
						  <tr>
						    ...
						    <td bgcolor="#F8F8F8">
						    <c:if test="${resumeInfo.gender == '男'}">
						    	<input type="radio" name="gender" value="男" checked="checked">男
						    	<input type="radio" name="gender" value="女">女
						    </c:if>
						     <c:if test="${resumeInfo.gender == '女'}">
						...
						<table width="300" border="0" cellpadding="3" cellspacing="1" bgcolor="#EEEEEE">
						  <tr>
						    ...
						    <td bgcolor="#F8F8F8"><input type="text" name="birthday" value="${resumeInfo.birthday}"></td>
						  </tr>
						</table>
						<div class="he"></div>
						<table width="300" border="0" cellpadding="3" cellspacing="1" bgcolor="#EEEEEE">
						  <tr>
						    ...
						    <td bgcolor="#F8F8F8"><input type="text" name="telephone" value="${resumeInfo.telephone}"></td>
						  </tr>
						</table>
						<div class="he"></div>
						<table width="300" border="0" cellpadding="3" cellspacing="1" bgcolor="#EEEEEE">
						  <tr>
						    ...
						    <td bgcolor="#F8F8F8"><input type="text" name="email" value="${resumeInfo.email}"></td>
						  </tr>
						</table>
						<div class="he"></div>
						<table width="300" border="0" cellpadding="3" cellspacing="1" bgcolor="#EEEEEE">
						  <tr>
						    ...
						    <td bgcolor="#F8F8F8"><input type="text" name="joIntension" value="${resumeInfo.joIntension}"></td>
						  </tr>
						</table>
						<div class="he"></div>
						<table width="300" border="0" cellpadding="3" cellspacing="1" bgcolor="#EEEEEE">
						  <tr>
						    ...
						    <td bgcolor="#F8F8F8"><input type="text" name="jobExperience" value="${resumeInfo.jobExperience}"></td>
						  </tr>
						</table>
						<div class="he"></div>
					...
					<div style="float:right" class="uploade">
						<img src="<%=basePath%>applicant/images/${resumeInfo.headShot}" height="110px" width="110px">
						<div align="center">
