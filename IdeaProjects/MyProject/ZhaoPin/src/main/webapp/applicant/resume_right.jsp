			...
			<div class="it-aside-fixed">
			  ...
			  <div id="resumeSavePreview">
					<div class="it-comment-btn">
				        <a id="reviewResume" class="tn-button tn-corner-all tn-button-text-only tn-button-preview" href="<%=basePath %>applicant/resumeView.jsp" target="_parent" plugin="dialog">
