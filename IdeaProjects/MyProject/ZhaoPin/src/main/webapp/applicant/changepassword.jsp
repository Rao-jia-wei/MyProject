  ...
  <div class="tn-box-content tn-corner-bottom">
    <div class="tn-tabs">
      <ul class="tn-tabs-nav tn-widget-content ">
        <li> <a href="my_resume.jsp"> 我的简历 </a> </li>
        <li> <a href="myapplys.jsp"> 我的申请 </a> </li>
        <li class="tn-tabs-selected"> <a class="tn-action tn-action-text-icon" href="ManageAccountBindings.jsp"> <span class="tn-icon tn-smallicon-add"> </span> <span class="tn-action-text"> 账号设置 </span> </a> </li>
      </ul>
        ...
        <div class="it-revese-password tn-helper-clearfix">
          <div class="it-aside">
            <ul class="tn-side-menu">
              <li class="tn-selected"> <a class="tn-menu-text" href="changepassword.jsp"> 修改密码 </a> </li>
              <li> <a class="tn-menu-text" href="ManageAccountBindings.jsp"> 账号绑定 </a> </li>
              <li> <a class="tn-menu-text" href="emailnoticesetting.jsp"> 邮件通知设置 </a> </li>
            </ul>
          </div>
          <div class="it-main">
