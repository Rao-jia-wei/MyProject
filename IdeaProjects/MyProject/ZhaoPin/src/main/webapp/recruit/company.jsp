      ...
      <div class="tn-helper-clearfix">
        <div class="it-main2">
          <div class="it-ctn-heading">
            <div class="it-title-line"> <span> <em>${company.company_viewnum} </em> 浏览 </span>
              <h3> 企业简介 </h3>
            </div>
          </div>
          <div class="it-com-textnote"> 
          		<span class="kuai"> 企业名称：${company.company_name} </span> 
          		<span class="kuai"> 所在地：${company.company_area} </span> 
          		<span class="kuai"> 规模：${company.company_size} </span> 
          		<span class="kuai"> 性质：${company.company_type} </span> </div>
          ...
          <p class="tn-helper-right"> <a href="/Home/SuccessCases?companyId=288" target="_blank" class="tn-action"> <span class="tn-icon"> </span> <span class="tn-action-text"> 成功案例 </span> </a> </p>
        </div>
      </div>
    </div>
  </div>
